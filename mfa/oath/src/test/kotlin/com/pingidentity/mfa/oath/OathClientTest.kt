...
import com.pingidentity.mfa.commons.StorageType
...
class OathClientTest {
    ...
    fun `test OathClient class exists and has factory methods`() {
        ...
        val createMethod = OathClient::class.java.getMethod("create")
        val invokeMethod = OathClient::class.java.getMethod("invoke", kotlin.jvm.functions.Function1::class.java)
        
        assertNotNull("OathClient.create method should exist", createMethod)
