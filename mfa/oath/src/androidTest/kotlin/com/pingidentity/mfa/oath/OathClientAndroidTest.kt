...
class OathClientAndroidTest {
    ...
    companion object {
        ...
        init {
            println("Enabling test mode for OathClientInstrumentedTest")
            com.pingidentity.mfa.commons.storage.TestModeDetector.enableTestMode()
        }
    }
    ...
    fun testCredentialSearch() {
        ...
        val uris = listOf(
            ...
            "otpauth://totp/SearchB:user3@example.com?secret=JBSWY3DPEHPK3PXP&issuer=SearchB"
        )
