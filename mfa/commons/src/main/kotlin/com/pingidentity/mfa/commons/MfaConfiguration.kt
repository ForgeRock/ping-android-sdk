 ...
 *
 * @property storageType The type of storage to use for MFA data (e.g., SQLite, SharedPreferences).
...
class MfaConfiguration private constructor(
    val storageType: StorageType = StorageType.SQL,
     ...
     */
    class Builder() {
        private var storageType: StorageType = StorageType.SQL
        ...
        /**
         * Sets the storage type for MFA data.
         *
         * @param storageType The storage type to use.
         * @return The builder instance.
         */
        fun storageType(storageType: StorageType): Builder {
...
/**
 * Enum representing the different storage types available for MFA data.
 */
