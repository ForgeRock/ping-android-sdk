...
The following table outlines the compatibility scenarios between different credential types and authentication methods across SDK versions and platforms:
