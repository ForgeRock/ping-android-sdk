...
If no customization lambda is provided, both registration and authentication use default configurations:

```kotlin
// Default registration
CreatePublicKeyCredentialRequest(publicKeyOptions.toString())

// Default authentication
GetPublicKeyCredentialOption(publicKeyOptions.toString())
```
