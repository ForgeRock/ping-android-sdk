...
class FidoCallbackTest {
    ...
    private lateinit var testCallback: FidoCallbackTest.TestFidoCallback
    ...
    private inner class TestFidoCallback : FidoCallback() {
    ...
    fun setUp() {
        ...
        testCallback = this@FidoCallbackTest.TestFidoCallback()
    ...
    fun `base64ToJson should decode base64 to JSON string`() {
        ...
        // When
        val result = with(testCallback) { base64String.base64ToStr() }
