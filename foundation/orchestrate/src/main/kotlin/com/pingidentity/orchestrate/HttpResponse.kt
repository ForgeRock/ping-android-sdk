 ...
 */
class HttpResponse(override val request: Request, private val httpResponse: HttpResponse) : Response {
    /**
     ...
     */
    override fun cookies(): Cookies = httpResponse.headers.getAll("Set-Cookie") ?: emptyList()
     ...
     */
    override fun header(name: String): String? = httpResponse.headers[name]
}