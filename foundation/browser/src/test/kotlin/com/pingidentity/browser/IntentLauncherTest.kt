...
class IntentLauncherTest {
    ...
    fun `launch with successful result`() = runTest {
        ...
        val customTabsIntentLauncher = CustomTabsIntentLauncher(mockLauncher, state)
        ...
        // Call launch method
        val result = customTabsIntentLauncher.launch("https://example.com", testUri)
    ...
    fun `launch with canceled result`() = runTest {
        ...
        val result = customTabsIntentLauncher.launch("https://example.com", "redirectUri".toUri())
    ...
    fun `launch with pending flag`() = runTest {
        ...
        val result = customTabsIntentLauncher.launch("https://example.com", "redirectUri".toUri(), pending = true)
