        ...
        Column(
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        coroutineScope.launch {
                            // Conditional first: attach the request so keyboard suggestions
                            // remain available on the field after dismissing the modal.
                            if (pending == null) attachPending()
                            // Modal fallback: covers attach failure and dismissed suggestions.
