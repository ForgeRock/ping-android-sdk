...
import com.pingidentity.pingonemfapp.util.QrCodeAnalyzer
                    ...
                    factory = { context ->
                        ...
                        imageAnalysis.setAnalyzer(
                            ...
                            QrCodeAnalyzer { qrCodeResult ->
                                ...
                                diagnosticLogger.d("QrScannerScreen: QR code result: $qrCodeResult")
                                viewModel.tryToPairUserForPingOneMFA(pairingKey = qrCodeResult)
                                onScanComplete()
                            }
                        )
